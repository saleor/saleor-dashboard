...
test("TC: SALEOR_14 User should be able to navigate to content list as a staff member using CONTENT aka PAGE permission @basic-regression", async ({
  page,
}) => {
...
test("TC: SALEOR_15 User should be able to navigate to page types list as a staff member using CONTENT aka PAGE permission @basic-regression", async ({
  page,
}) => {
  const basePage = new BasePage(page);
