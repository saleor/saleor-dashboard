...
test("TC: SALEOR_23 User should be able to navigate to product list as a staff member using PRODUCT permission @basic-regression", async ({
  page,
}) => {
...
test("TC: SALEOR_24 User should be able to navigate to collections list as a staff member using PRODUCT permission @basic-regression", async ({
  page,
}) => {
  const mainMenuPage = new MainMenuPage(page);
  const basePage = new BasePage(page);
...
test("TC: SALEOR_25 User should be able to navigate to categories list as a staff member using PRODUCT permission @basic-regression", async ({
  page,
}) => {
  const mainMenuPage = new MainMenuPage(page);
  const basePage = new BasePage(page);
