...
export class VouchersPage extends BasePage {
  ...
  constructor(
    ...
    readonly percentDiscountTypeButton = page.getByTestId("VALUE_PERCENTAGE").locator("button"),
    readonly freeShippingDiscountTypeButton = page.getByTestId("SHIPPING").locator("button"),
    readonly minimalOrderValueButton = page.getByTestId("ORDER").locator("button"),
    readonly minimumQuantityOfItemsButton = page.getByTestId("ITEM").locator("button"),
    readonly specificProductsButton = page.getByTestId("SPECIFIC_PRODUCT").locator("button"),
