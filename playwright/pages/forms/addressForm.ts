...
export class AddressForm extends BasePage {
  constructor(
    page: Page,
    readonly firstNameInput = page.getByTestId("first-name-input"),
    readonly lastNameInput = page.getByTestId("last-name-input"),
    readonly companyNameInput = page.getByTestId("company-name-input"),
    readonly phoneInput = page.getByTestId("phone-input"),
    readonly cityInput = page.getByTestId("city-input"),
    readonly zipInput = page.getByTestId("zip-input"),
    readonly addressLine1Input = page.getByTestId("address-line-1-input"),
    readonly addressLine2Input = page.getByTestId("address-line-2-input"),
