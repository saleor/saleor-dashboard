...
export class CustomersPage extends BasePage {
  ...
  constructor(
    ...
    readonly customerFirstNameInput = page.getByTestId("customer-first-name"),
    readonly customerLastNameInput = page.getByTestId("customer-last-name"),
    readonly customerEmailInput = page.getByTestId("customer-email"),
    readonly customerNoteInput = page.getByTestId("customer-note"),
