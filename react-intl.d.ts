declare module "react-intl" {
  ...
  type Messages<Names extends keyof any = string> = Record<Names, MessageDescriptor>;
  type PrimitiveType = string | number | boolean | null | undefined | Date;
  type FormatXMLElementFn = (...args: any[]) => string | {};
  export interface IntlFormatters extends Omit<ReactIntl.IntlFormatters, "formatMessage"> {
