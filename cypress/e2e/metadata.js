...
import { updateMetadata, updatePrivateMetadata } from "../support/api/requests/Metadata";
...
describe("Test for metadata", () => {
  ...
  it("should create metadata for product", { tags: ["@metadata", "@allEnv", "@stable"] }, () => {
    cy.clearSessionData().loginUserViaRequest();
  ...
  it("should create metadata for order", { tags: ["@metadata", "@allEnv", "@stable"] }, () => {
    let order;
    cy.clearSessionData().loginUserViaRequest();
