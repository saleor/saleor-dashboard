...
describe("Updating products without sku", () => {
  ...
  before(() => {
    ...
    getDefaultChannel()
      ...
      .then(productResp => {
        product = productResp
        cy.checkIfDataAreNotNull({ defaultChannel, address, warehouse, shippingMethod, attribute, category, productTypeWithVariants, productTypeWithoutVariants, product })
      });
  });
