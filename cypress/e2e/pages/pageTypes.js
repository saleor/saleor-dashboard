...
import { createPageType, getPageType } from "../../support/api/requests/PageType";
...
describe("Tests for page types", () => {
  ...
  it("should create page type. TC: SALEOR_2301", { tags: ["@pages", "@allEnv", "@stable"] }, () => {
  ...
  it("should assign attribute. TC: SALEOR_2302", { tags: ["@pages", "@allEnv"] }, () => {
    const randomName = startsWith + faker.datatype.number();
