...
export const ONE_PERMISSION_USERS = {
  ...
  pageTypeAndAttribute: getOnePermissionUser("page.type.and.attribute.manager@example.com"),
  productTypeAndAttribute: getOnePermissionUser("product.type.and.attribute.manager@example.com"),
