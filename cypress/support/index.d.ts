declare namespace Cypress {
  interface FindElementsAndMakeActionOnTableProps {
  ...
  interface Chainable {
    ...
    expectCorrectFullAddress(responseAddress: string, expectedAddress: string): Chainable<any>;
    expectCorrectBasicAddress(responseAddress: string, expectedAddress: string): Chainable<any>;
    ...
    fillAutocompleteSelect(selectSelector: string, option?: string): Chainable<any>;
    ...
    findElementsAndMakeActionOnTable(props: FindElementsAndMakeActionOnTableProps): Chainable<any>;
