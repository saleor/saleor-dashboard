...
describe("Create attribute with type", () => {
  ...
  attributesTypes.forEach(attributeType => {
    it(`should create ${attributeType} attribute`, () => {
      ...
      createAttributeWithInputType({ name: attributeName, attributeType })
        ...
        .then(attribute => {
          expectCorrectDataInAttribute(attribute.id, {
            attributeName,
            attributeType
          });
        });
  ...
  //     const attributeName = `${startsWith}${faker.datatype.number()}`;
  //     createAttributeWithInputType({ name: attributeName, attributeType, entityType })
  //       .then(({ attribute }) => {
  //         getAttribute(attribute.id)
  //       })
  //       .then(attribute => {
  //         expectCorrectDataInAttribute(attribute.id, { attributeName, attributeType, entityType })
  //       })
  //   });
  // });
  ...
  //     const attributeName = `${startsWith}${faker.datatype.number()}`;
  //     createAttributeWithInputType({ name: attributeName, attributeType, numericSystemType })
  //       .then(({ attribute }) => {
  //         getAttribute(attribute.id)
  //       })
  //       .then(attribute => {
  //         expectCorrectDataInAttribute(attribute.id, { attributeName, attributeType, unit: numericSystemType.unit })
  //       })
  //   });
  // });
  ...
  //   const attributeName = `${startsWith}${faker.datatype.number()}`;
  //   createAttributeWithInputType({ name: attributeName, attributeType, valueRequired: false })
  //     .then(({ attribute }) => {
  //       getAttribute(attribute.id)
  //     })
  //     .then(attribute => {
  //       expectCorrectDataInAttribute(attribute.id, { attributeName, attributeType, valueRequired: false })
  //     })
  // });
});
