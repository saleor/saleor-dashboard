import { BulkAction, Dialog, Pagination, SingleAction, Sort, TabActionDialog } from '@dashboard/types';
...
export const permissionGroupDetailsUrl = (id: string, params?: PermissionGroupDetailsUrlQueryParams) =>
