...
storiesOf('Orders / Refund order', module)
  ...
  .add('products', () => <OrderRefundPage {...props} defaultType={OrderRefundType.PRODUCTS} />)
  .add('miscellaneous', () => <OrderRefundPage {...props} defaultType={OrderRefundType.MISCELLANEOUS} />)
  .add('loading', () => <OrderRefundPage {...props} disabled={true} order={undefined} />);
