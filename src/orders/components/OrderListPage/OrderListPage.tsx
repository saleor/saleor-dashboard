import { extensionMountPoints, mapToMenuItems, useExtensions } from '@dashboard/apps/useExtensions';
...
const OrderListPage: React.FC<OrderListPageProps> = ({
  ...
  const { ORDER_OVERVIEW_CREATE, ORDER_OVERVIEW_MORE_ACTIONS } = useExtensions(extensionMountPoints.ORDER_LIST);
