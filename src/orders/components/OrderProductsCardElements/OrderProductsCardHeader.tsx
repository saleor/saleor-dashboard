      ...
      <TableHead>
        <TableRowLink>
          ...
          <TableCell className={classes.colQuantity}>
            <FormattedMessage id="tvpAXl" defaultMessage="Quantity" description="ordered product quantity" />
          </TableCell>
          <TableCell className={classes.colPrice}>
            <FormattedMessage id="b810WJ" defaultMessage="Price" description="product price" />
          </TableCell>
          <TableCell className={classes.colTotal}>
            <FormattedMessage id="qT6YYk" defaultMessage="Total" description="order line total price" />
          </TableCell>
        </TableRowLink>
      </TableHead>
    </>
