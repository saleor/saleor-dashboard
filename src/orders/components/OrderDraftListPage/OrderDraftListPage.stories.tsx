...
import OrderDraftListPage, { OrderDraftListPageProps } from "./OrderDraftListPage";
...
storiesOf("Orders / Draft order list", module)
  ...
  .add("loading", () => <OrderDraftListPage {...props} disabled orders={undefined} />)
  .add("when no data", () => <OrderDraftListPage {...props} orders={[]} />)
  .add("limits reached", () => <OrderDraftListPage {...props} limits={limitsReached} />);
