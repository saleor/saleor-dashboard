...
import { useFulfillOrderMutation, useOrderFulfillDataQuery, useOrderFulfillSettingsQuery } from '@dashboard/graphql';
import useNavigator from '@dashboard/hooks/useNavigator';
import useNotifier from '@dashboard/hooks/useNotifier';
import { getMutationErrors } from '@dashboard/misc';
import OrderFulfillPage, { OrderFulfillSubmitData } from '@dashboard/orders/components/OrderFulfillPage';
import { orderFulfillUrl, OrderFulfillUrlDialog, OrderFulfillUrlQueryParams, orderUrl } from '@dashboard/orders/urls';
...
const OrderFulfill: React.FC<OrderFulfillProps> = ({ orderId, params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<OrderFulfillUrlDialog, OrderFulfillUrlQueryParams>(
    navigate,
    params => orderFulfillUrl(orderId, params),
    params,
  );
