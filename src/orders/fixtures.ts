...
export const orderLineSearch = (placeholderImage: string): RelayToFlat<SearchOrderVariantQuery['search']> => [
  {
...
export const warehouseSearch: SearchWarehousesQuery['search'] = {
  ...
  pageInfo: {
    endCursor: 'WyJXaXRob3V0U2hpcG1lbnRDaGVja291dC00NTA1IiwgIldpdGhvdXRTaGlwbWVudENoZWNrb3V0LTQ1MDUiXQ==',
    hasNextPage: false,
