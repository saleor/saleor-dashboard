...
export interface OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderConfirm_orderConfirm_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderConfirm_orderConfirm_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderConfirm_orderConfirm_order_lines_variant_product_productType;
}
...
export interface OrderConfirm_orderConfirm_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderConfirm_orderConfirm_order_lines_variant_product;
}
