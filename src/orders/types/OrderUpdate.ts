...
import { OrderUpdateInput, OrderErrorCode, AddressTypeEnum, OrderDiscountType, DiscountValueTypeEnum, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentStatus, PaymentChargeStatusEnum, OrderAction, OrderPaymentStatusEnum, OrderStatus, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderUpdate_orderUpdate_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderUpdate_orderUpdate_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderUpdate_orderUpdate_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderUpdate_orderUpdate_order_payments {
  __typename: "Payment";
  id: string;
  total: OrderUpdate_orderUpdate_order_payments_total | null;
  capturedAmount: OrderUpdate_orderUpdate_order_payments_capturedAmount | null;
  gatewayName: string;
  availableCaptureAmount: OrderUpdate_orderUpdate_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderUpdate_orderUpdate_order_payments_availableRefundAmount | null;
  pspReference: string | null;
