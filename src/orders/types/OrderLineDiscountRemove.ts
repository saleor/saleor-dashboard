...
export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_capturedAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountRemove_orderLineDiscountRemove_order_payments {
  __typename: "Payment";
  id: string;
  total: OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_total | null;
  capturedAmount: OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_capturedAmount | null;
  gatewayName: string;
  availableCaptureAmount: OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderLineDiscountRemove_orderLineDiscountRemove_order_payments_availableRefundAmount | null;
  pspReference: string | null;
...
export interface OrderLineDiscountRemove_orderLineDiscountRemove_order {
  ...
  number: string | null;
  payments: (OrderLineDiscountRemove_orderLineDiscountRemove_order_payments | null)[] | null;
