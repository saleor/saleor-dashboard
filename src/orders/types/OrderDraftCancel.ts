...
export interface OrderDraftCancel_draftOrderDelete_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDraftCancel_draftOrderDelete_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderDraftCancel_draftOrderDelete_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDraftCancel_draftOrderDelete_order_payments {
  ...
  gatewayName: string;
  availableCaptureAmount: OrderDraftCancel_draftOrderDelete_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderDraftCancel_draftOrderDelete_order_payments_availableRefundAmount | null;
  pspReference: string | null;
