...
export interface OrderDraftFinalize_draftOrderComplete_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDraftFinalize_draftOrderComplete_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderDraftFinalize_draftOrderComplete_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDraftFinalize_draftOrderComplete_order_payments {
  __typename: "Payment";
  id: string;
  total: OrderDraftFinalize_draftOrderComplete_order_payments_total | null;
  capturedAmount: OrderDraftFinalize_draftOrderComplete_order_payments_capturedAmount | null;
  gatewayName: string;
  availableCaptureAmount: OrderDraftFinalize_draftOrderComplete_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderDraftFinalize_draftOrderComplete_order_payments_availableRefundAmount | null;
  pspReference: string | null;
