...
export interface OrderDraftFinalize_draftOrderComplete_order_events_fulfilledItems_orderLine {
...
export interface OrderDraftFinalize_draftOrderComplete_order_events_fulfilledItems {
  __typename: "FulfillmentLine";
  id: string;
  quantity: number;
  orderLine: OrderDraftFinalize_draftOrderComplete_order_events_fulfilledItems_orderLine | null;
}
...
export interface OrderDraftFinalize_draftOrderComplete_order_events {
  ...
  fulfilledItems: (OrderDraftFinalize_draftOrderComplete_order_events_fulfilledItems | null)[] | null;
}
