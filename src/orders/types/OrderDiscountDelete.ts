...
export interface OrderDiscountDelete_orderDiscountDelete_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderDiscountDelete_orderDiscountDelete_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDiscountDelete_orderDiscountDelete_order_payments {
  ...
  gatewayName: string;
  availableCaptureAmount: OrderDiscountDelete_orderDiscountDelete_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderDiscountDelete_orderDiscountDelete_order_payments_availableRefundAmount | null;
  pspReference: string | null;
