...
export interface OrderDiscountDelete_orderDiscountDelete_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderDiscountDelete_orderDiscountDelete_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderDiscountDelete_orderDiscountDelete_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderDiscountDelete_orderDiscountDelete_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderDiscountDelete_orderDiscountDelete_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderDiscountDelete_orderDiscountDelete_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderDiscountDelete_orderDiscountDelete_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderDiscountDelete_orderDiscountDelete_order_lines_variant_product_productType;
}
...
export interface OrderDiscountDelete_orderDiscountDelete_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderDiscountDelete_orderDiscountDelete_order_lines_variant_product;
}
