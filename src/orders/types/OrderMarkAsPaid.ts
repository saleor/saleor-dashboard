...
export interface OrderMarkAsPaid_orderMarkAsPaid_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderMarkAsPaid_orderMarkAsPaid_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderMarkAsPaid_orderMarkAsPaid_order_payments {
  ...
  gatewayName: string;
  availableCaptureAmount: OrderMarkAsPaid_orderMarkAsPaid_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderMarkAsPaid_orderMarkAsPaid_order_payments_availableRefundAmount | null;
  pspReference: string | null;
