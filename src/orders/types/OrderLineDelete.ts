...
export interface OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderLineDelete_orderLineDelete_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLineDelete_orderLineDelete_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLineDelete_orderLineDelete_order_lines_variant_product_productType;
}
...
export interface OrderLineDelete_orderLineDelete_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderLineDelete_orderLineDelete_order_lines_variant_product;
}
