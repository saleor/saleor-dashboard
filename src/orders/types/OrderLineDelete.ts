...
export interface OrderLineDelete_orderLineDelete_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDelete_orderLineDelete_order_payments_capturedAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDelete_orderLineDelete_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDelete_orderLineDelete_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDelete_orderLineDelete_order_payments {
  __typename: "Payment";
  id: string;
  total: OrderLineDelete_orderLineDelete_order_payments_total | null;
  capturedAmount: OrderLineDelete_orderLineDelete_order_payments_capturedAmount | null;
  gatewayName: string;
  availableCaptureAmount: OrderLineDelete_orderLineDelete_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderLineDelete_orderLineDelete_order_payments_availableRefundAmount | null;
  pspReference: string | null;
...
export interface OrderLineDelete_orderLineDelete_order {
  ...
  number: string | null;
  payments: (OrderLineDelete_orderLineDelete_order_payments | null)[] | null;
