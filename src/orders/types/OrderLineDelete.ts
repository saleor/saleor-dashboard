...
export interface OrderLineDelete_draftOrderLineDelete_order_events_fulfilledItems_orderLine {
...
export interface OrderLineDelete_draftOrderLineDelete_order_events_fulfilledItems {
  __typename: "FulfillmentLine";
  id: string;
  quantity: number;
  orderLine: OrderLineDelete_draftOrderLineDelete_order_events_fulfilledItems_orderLine | null;
}
...
export interface OrderLineDelete_draftOrderLineDelete_order_events {
  ...
  fulfilledItems: (OrderLineDelete_draftOrderLineDelete_order_events_fulfilledItems | null)[] | null;
}
