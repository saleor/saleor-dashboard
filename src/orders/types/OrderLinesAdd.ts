...
export interface OrderLinesAdd_orderLinesCreate_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLinesAdd_orderLinesCreate_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLinesAdd_orderLinesCreate_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderLinesAdd_orderLinesCreate_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderLinesAdd_orderLinesCreate_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderLinesAdd_orderLinesCreate_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLinesAdd_orderLinesCreate_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLinesAdd_orderLinesCreate_order_lines_variant_product_productType;
}
...
export interface OrderLinesAdd_orderLinesCreate_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderLinesAdd_orderLinesCreate_order_lines_variant_product;
}
