...
export interface OrderLinesAdd_draftOrderLinesCreate_order_events_fulfilledItems_orderLine {
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_events_fulfilledItems {
  __typename: "FulfillmentLine";
  id: string;
  quantity: number;
  orderLine: OrderLinesAdd_draftOrderLinesCreate_order_events_fulfilledItems_orderLine | null;
}
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_events {
  ...
  fulfilledItems: (OrderLinesAdd_draftOrderLinesCreate_order_events_fulfilledItems | null)[] | null;
}
