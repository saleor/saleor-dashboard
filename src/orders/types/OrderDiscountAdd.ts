...
export interface OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderDiscountAdd_orderDiscountAdd_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderDiscountAdd_orderDiscountAdd_order_lines_variant_product_productType;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderDiscountAdd_orderDiscountAdd_order_lines_variant_product;
}
