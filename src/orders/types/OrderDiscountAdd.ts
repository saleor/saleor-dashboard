...
export interface OrderDiscountAdd_orderDiscountAdd_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderDiscountAdd_orderDiscountAdd_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_payments {
  ...
  gatewayName: string;
  availableCaptureAmount: OrderDiscountAdd_orderDiscountAdd_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderDiscountAdd_orderDiscountAdd_order_payments_availableRefundAmount | null;
  pspReference: string | null;
