...
export interface OrderDetails_order_events_fulfilledItems_orderLine {
...
export interface OrderDetails_order_events_fulfilledItems {
  __typename: "FulfillmentLine";
  id: string;
  quantity: number;
  orderLine: OrderDetails_order_events_fulfilledItems_orderLine | null;
}
...
export interface OrderDetails_order_events {
  ...
  fulfilledItems: (OrderDetails_order_events_fulfilledItems | null)[] | null;
}
