...
import { OrderUpdateShippingInput, OrderErrorCode, AddressTypeEnum, OrderDiscountType, DiscountValueTypeEnum, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentStatus, PaymentChargeStatusEnum, OrderAction, OrderPaymentStatusEnum, OrderStatus, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderShippingMethodUpdate_orderUpdateShipping_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderShippingMethodUpdate_orderUpdateShipping_order_payments_capturedAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderShippingMethodUpdate_orderUpdateShipping_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderShippingMethodUpdate_orderUpdateShipping_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderShippingMethodUpdate_orderUpdateShipping_order_payments {
  __typename: "Payment";
  id: string;
  ...
  gatewayName: string;
  availableCaptureAmount: OrderShippingMethodUpdate_orderUpdateShipping_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderShippingMethodUpdate_orderUpdateShipping_order_payments_availableRefundAmount | null;
  pspReference: string | null;
...
export interface OrderShippingMethodUpdate_orderUpdateShipping_order {
  ...
  number: string | null;
  payments: (OrderShippingMethodUpdate_orderUpdateShipping_order_payments | null)[] | null;
