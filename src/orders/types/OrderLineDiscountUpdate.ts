...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_fulfillments_lines_orderLine_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_fulfillments_lines_orderLine_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_fulfillments_lines_orderLine_variant_product_productType;
}
...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_fulfillments_lines_orderLine_variant_product;
}
...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_lines_variant_product_productType {
  __typename: "ProductType";
  id: string;
  kind: ProductTypeKindEnum;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_lines_variant_product {
  __typename: "Product";
  id: string;
  productType: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_lines_variant_product_productType;
}
...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_lines_variant {
  ...
  id: string;
  quantityAvailable: number;
  product: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_lines_variant_product;
}
