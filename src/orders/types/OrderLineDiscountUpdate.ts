...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_total {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_capturedAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_availableCaptureAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_availableRefundAmount {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments {
  __typename: "Payment";
  id: string;
  ...
  gatewayName: string;
  availableCaptureAmount: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_availableCaptureAmount | null;
  availableRefundAmount: OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments_availableRefundAmount | null;
  pspReference: string | null;
...
export interface OrderLineDiscountUpdate_orderLineDiscountUpdate_order {
  ...
  number: string | null;
  payments: (OrderLineDiscountUpdate_orderLineDiscountUpdate_order_payments | null)[] | null;
