...
export interface OrderRefund_orderRefund_order_events_fulfilledItems_orderLine {
...
export interface OrderRefund_orderRefund_order_events_fulfilledItems {
  __typename: "FulfillmentLine";
  id: string;
  quantity: number;
  orderLine: OrderRefund_orderRefund_order_events_fulfilledItems_orderLine | null;
}
...
export interface OrderRefund_orderRefund_order_events {
  ...
  fulfilledItems: (OrderRefund_orderRefund_order_events_fulfilledItems | null)[] | null;
}
