...
import styles from "./ChannelSettingToggleRow.module.css";

interface ChannelSettingToggleRowProps {
  title: ReactNode;
...
export const ChannelSettingToggleRow = ({
  title,
  description,
  pressed,
  onPressedChange,
...
export const ChannelSettingNestedField = ({ children }: { children: ReactNode }) => (
