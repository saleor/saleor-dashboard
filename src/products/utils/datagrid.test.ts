...
describe('isCurrentRow', () => {
  test('should return true when variant index is equal to datagrid row index and no removed rows', () => {
    ...
    // Assert
    expect(isCurrentRow(datagridChangeRowIndex, variantIndex, datagridRemoveRowsIds)).toEqual(true);
  });
  ...
  test('should return false when variant index is not equal to datagrid row index ', () => {
    ...
    // Assert
    expect(isCurrentRow(datagridChangeRowIndex, variantIndex, datagridRemoveRowsIds)).toEqual(false);
  });
