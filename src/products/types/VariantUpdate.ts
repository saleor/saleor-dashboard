...
export interface VariantUpdate_productVariantUpdate_productVariant_channelListing {
  ...
  costPrice: VariantUpdate_productVariantUpdate_productVariant_channelListing_costPrice;
  price: VariantUpdate_productVariantUpdate_productVariant_channelListing_price;
}
...
export interface VariantUpdate_productVariantStocksUpdate_productVariant_channelListing {
  ...
  costPrice: VariantUpdate_productVariantStocksUpdate_productVariant_channelListing_costPrice;
  price: VariantUpdate_productVariantStocksUpdate_productVariant_channelListing_price;
}
