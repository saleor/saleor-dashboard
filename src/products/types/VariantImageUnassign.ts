...
export interface VariantImageUnassign_variantImageUnassign_productVariant_channelListing {
  ...
  costPrice: VariantImageUnassign_variantImageUnassign_productVariant_channelListing_costPrice;
  price: VariantImageUnassign_variantImageUnassign_productVariant_channelListing_price;
}
