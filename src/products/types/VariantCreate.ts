...
export interface VariantCreate_productVariantCreate_productVariant_product_variants {
  ...
  name: string;
  sku: string;
  media: (VariantCreate_productVariantCreate_productVariant_product_variants_media | null)[] | null;
}
...
export interface VariantCreate_productVariantCreate_productVariant {
  ...
  media: (VariantCreate_productVariantCreate_productVariant_media | null)[] | null;
  name: string;
