...
export interface ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_product_variants {
  ...
  name: string;
  sku: string;
  media: (ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_product_variants_media | null)[] | null;
}
...
export interface ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant {
  ...
  media: (ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_media | null)[] | null;
  name: string;
