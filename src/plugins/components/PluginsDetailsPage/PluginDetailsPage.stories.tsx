...
import PluginsDetailsPage, { PluginDetailsPageFormData, PluginsDetailsPageProps } from './PluginsDetailsPage';
...
storiesOf('Plugins / Plugin details', module)
  ...
  .add('loading', () => <PluginsDetailsPage {...props} disabled={true} plugin={undefined} />)
  .add('form errors', () => (
    <PluginsDetailsPage
      {...props}
      errors={[
        ...(['active', 'Username or account', 'Password or license'] as Array<keyof PluginDetailsPageFormData>).map(
          field => ({
