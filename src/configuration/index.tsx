      ...
      menuItems: [
        {
          ...
          icon: <PageTypes />,
          permissions: [PermissionEnum.MANAGE_PAGES, PermissionEnum.MANAGE_PAGE_TYPES_AND_ATTRIBUTES],
    ...
    },
    {
      ...
      menuItems: [
        ...
        },
        {
          ...
          icon: <Plugins fontSize="inherit" viewBox="-8 -5 44 44" preserveAspectRatio="xMinYMin meet" />,
...
export const ConfigurationSection: React.FC = () => {
  ...
  return (
    <>
      ...
      <ConfigurationPage menu={createConfigurationMenu(intl)} user={maybe(() => user.user)} versionInfo={versions} />
    </>
  );
};
