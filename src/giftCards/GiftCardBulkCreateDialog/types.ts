...
export type GiftCardErrorKey = 'tags' | 'expiryDate' | 'currency' | 'expiryPeriod' | 'amount' | 'balance' | 'count';
...
export type GiftCardBulkCreateFormErrors = Partial<Record<GiftCardErrorKey, GiftCardBulkCreateFormError>>;
