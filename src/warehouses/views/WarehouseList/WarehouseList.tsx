...
import { warehouseListUrl, WarehouseListUrlDialog, WarehouseListUrlQueryParams } from '@dashboard/warehouses/urls';
...
const WarehouseList: React.FC<WarehouseListProps> = ({ params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<WarehouseListUrlDialog, WarehouseListUrlQueryParams>(
    navigate,
    warehouseListUrl,
    params,
  );
