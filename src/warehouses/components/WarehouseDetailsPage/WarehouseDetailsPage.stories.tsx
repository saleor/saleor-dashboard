...
import WarehouseDetailsPage, { WarehouseDetailsPageFormData, WarehouseDetailsPageProps } from './WarehouseDetailsPage';
...
storiesOf('Warehouses / Warehouse details', module)
  ...
  .add('loading', () => <WarehouseDetailsPage {...props} warehouse={undefined} disabled={true} />)
  .add('form errors', () => (
