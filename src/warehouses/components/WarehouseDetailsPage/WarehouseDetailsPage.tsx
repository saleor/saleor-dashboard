...
const WarehouseDetailsPage: React.FC<WarehouseDetailsPageProps> = ({
  ...
  const [displayCountry, setDisplayCountry] = useStateFromProps(warehouse?.address?.country.country || '');
  ...
  const initialForm: WarehouseDetailsPageFormData = {
    ...
    clickAndCollectOption: warehouse?.clickAndCollectOption || WarehouseClickAndCollectOptionEnum.DISABLED,
