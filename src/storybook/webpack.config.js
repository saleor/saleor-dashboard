...
module.exports = ({ config }) => {
  ...
  config.resolve.alias = {
    '@saleor/macaw-ui/next': path.resolve('./node_modules/@saleor/macaw-ui/dist/macaw-ui.js'),
    '@saleor/macaw-ui': path.resolve('./node_modules/@saleor/macaw-ui/legacy/dist/esm/index.js'),
