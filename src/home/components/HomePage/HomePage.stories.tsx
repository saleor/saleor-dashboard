...
storiesOf('Home', module)
  ...
  .add('no data', () => <HomePage {...homePageProps} topProducts={[]} activities={[]} />)
  .add('no permissions', () => <HomePage {...homePageProps} customPermissions={[]} />)
  .add('product permissions', () => (
    <HomePage
      {...homePageProps}
      customPermissions={adminUserPermissions.filter(perm => perm.code === PermissionEnum.MANAGE_PRODUCTS)}
    />
  ))
  .add('order permissions', () => (
    <HomePage
      {...homePageProps}
      customPermissions={adminUserPermissions.filter(perm => perm.code === PermissionEnum.MANAGE_ORDERS)}
    />
  ));
