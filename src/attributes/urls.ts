...
export const attributeListUrl = (params?: AttributeListUrlQueryParams) => attributeListPath + '?' + stringifyQs(params);
...
export const attributeAddUrl = (params?: AttributeAddUrlQueryParams) => attributeAddPath + '?' + stringifyQs(params);

export type AttributeUrlDialog = 'add-value' | 'edit-value' | 'remove' | 'remove-value' | 'remove-values';
