    ...
    <ResponsiveTable>
      ...
      >
        <TableCellHeader
          ...
          direction={
            sort.sort === AttributeListUrlSortField.slug ? getArrowDirection(!!sort.asc) : undefined
          }
          arrowPosition="right"
        ...
        <TableCellHeader
          ...
          direction={
            sort.sort === AttributeListUrlSortField.name ? getArrowDirection(!!sort.asc) : undefined
          }
