...
import { AttributeEntityTypeEnum, AttributeErrorFragment, AttributeInputTypeEnum } from '@dashboard/graphql';
...
export interface AttributeDetailsProps
  extends Pick<UseFormResult<AttributePageFormData>, 'set' | 'setError' | 'data' | 'clearErrors' | 'errors'> {
...
const AttributeDetails: React.FC<AttributeDetailsProps> = props => {
  const { canChangeType, errors, clearErrors, setError, data, disabled, apiErrors, onChange, set } = props;
