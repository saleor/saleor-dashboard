...
const AttributeListPage: React.FC<AttributeListPageProps> = ({
  ...
  return (
    <>
      <TopNav href={configurationMenuUrl} title={intl.formatMessage(sectionNames.attributes)}>
        <Button href={attributeAddUrl()} variant="primary" data-test-id="create-attribute-button">
          <FormattedMessage id="IGvQ8k" defaultMessage="Create attribute" description="button" />
        </Button>
      </TopNav>
      <Card>
        <FilterBar
