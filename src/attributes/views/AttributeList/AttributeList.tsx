...
const AttributeList: React.FC<AttributeListProps> = ({ params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<AttributeListUrlDialog, AttributeListUrlQueryParams>(
    navigate,
    attributeListUrl,
    params,
  );
  ...
  return (
    <PaginatorContext.Provider value={paginationValues}>
      ...
      <AttributeBulkDeleteDialog
        ...
        open={params.action === 'remove' && !!params.ids && params.ids.length > 0}
