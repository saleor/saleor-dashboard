...
import ProductTypeCreatePage, { ProductTypeCreatePageProps, ProductTypeForm } from './ProductTypeCreatePage';
...
storiesOf('Product types / Create product type', module)
  ...
  .add('loading', () => <ProductTypeCreatePage {...props} disabled={true} pageTitle={undefined} />)
  .add('form errors', () => (
    <ProductTypeCreatePage {...props} errors={(['name'] as Array<keyof ProductTypeForm>).map(formError)} />
  ));
