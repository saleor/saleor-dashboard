        ...
        <Box marginBottom={2} paddingX={4}>
          <Text>
            {intl.formatMessage({
              ...
              description: "event delivery attempts count label",
              id: "eQbQLB",
            })}{" "}
          ...
          <Text as="p">
            {intl.formatMessage({
              ...
              description: "event delivery last attempt date label",
              id: "Q0V6OG",
            })}{" "}
          ...
          <Text>
            {intl.formatMessage({
              defaultMessage: "ID:",
              description: "event delivery id label",
              id: "4oYRyT",
            })}
            <Text size={4} marginLeft={2}>
              {deliveryId}
            </Text>
          </Text>
        </Box>
