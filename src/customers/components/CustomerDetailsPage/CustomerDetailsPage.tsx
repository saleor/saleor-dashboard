import { extensionMountPoints, mapToMenuItemsForCustomerDetails, useExtensions } from '@dashboard/apps/useExtensions';
      ...
      {({ change, data, isSaveDisabled, submit }) => {
        ...
        return (
          <DetailedContent>
            ...
            <Content>
              <Backlink href={customerListUrl()}>{intl.formatMessage(sectionNames.customers)}</Backlink>
              <CustomerDetails customer={customer} data={data} disabled={disabled} errors={errors} onChange={change} />
              <CardSpacer />
