...
export const AppUrls = {
  resolveAppListUrl: (params?: AppListUrlQueryParams) => AppPaths.appListPath + '?' + stringifyQs(params),
  ...
  resolveAppInstallUrl: (manifestUrl: string) => `${AppPaths.appInstallPath}?manifestUrl=${manifestUrl}`,
