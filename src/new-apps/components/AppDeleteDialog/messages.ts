...
export default defineMessages({
  ...
  deleteLocalApp: {
    id: '0vsMRq',
    defaultMessage: 'Deleting this app, you will delete all the data and webhooks regarding this app.',
  ...
  deleteLocalNamedApp: {
    id: 'nioOBQ',
    defaultMessage: 'Deleting {name}, you will delete all the data and webhooks regarding this app.',
    description: 'delete custom app',
  },
  deleteAppQuestion: {
    id: '6hLZNA',
