...
export interface InProgressAppListProps {
  appsList: AppsInstallationsQuery["appsInstallations"];
  onAppInstallRetry: (id: string) => void;
  onRemove: (id: string) => void;
}

const InProgressAppList: React.FC<InProgressAppListProps> = ({
  appsList,
  onAppInstallRetry,
  onRemove,
  ...props
...
InProgressAppList.displayName = "InProgressAppList";
export default InProgressAppList;
