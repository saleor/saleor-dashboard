...
import { comingSoonApp, failedAppInProgress, pendingAppInProgress, releasedApp } from '@dashboard/new-apps/fixtures';
...
describe('Apps AppListCard', () => {
  it('displays released app details when released app data passed', () => {
    // Arrange
    const integrationImages = releasedApp.integrations.map(integration => integration.logo.light.source);
    render(
      <Wrapper>
    ...
    const expectedLinks = [releasedApp.privacyUrl, releasedApp.repositoryUrl, releasedApp.supportUrl];
  ...
  it('displays coming soon app details when coming soon app data passed', () => {
    // Arrange
    const integrationImages = comingSoonApp.integrations.map(integration => integration.logo.light.source);
    render(
      <Wrapper>
  ...
  it('displays app installation details when failed installation data passed', () => {
    ...
    const statusDetails = within(status).queryByText(appInstallationStatusMessages.failed.defaultMessage);
  ...
  it('displays app installation details when pending installation data passed', () => {
    ...
    const statusText = within(status).queryByText(appInstallationStatusMessages.pending.defaultMessage);
