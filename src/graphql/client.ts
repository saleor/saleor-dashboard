...
import introspectionQueryResultDataUnstable from "./fragmentTypesUnstable.generated";
import { isUnstableSchema } from "./schemaVersion";
...
const introspectionData = isUnstableSchema()
  ? introspectionQueryResultDataUnstable
