 ...
 * });
 */
export function useSingleOrderQuery(baseOptions: ApolloReactHooks.QueryHookOptions<Types.SingleOrderQuery, Types.SingleOrderQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<Types.SingleOrderQuery, Types.SingleOrderQueryVariables>(SingleOrderDocument, options);
      }
export function useSingleOrderLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Types.SingleOrderQuery, Types.SingleOrderQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<Types.SingleOrderQuery, Types.SingleOrderQueryVariables>(SingleOrderDocument, options);
        }
...
export type SingleOrderQueryResult = Apollo.QueryResult<Types.SingleOrderQuery, Types.SingleOrderQueryVariables>;
