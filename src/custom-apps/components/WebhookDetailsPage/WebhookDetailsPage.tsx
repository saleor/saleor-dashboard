...
import { createAsyncEventsSelectHandler, createSyncEventsSelectHandler } from '@dashboard/custom-apps/handlers';
          ...
          <DetailedContent useSingleColumn>
            ...
            <Content>
              <Box paddingX={9}>
                ...
                />
                <WebhookSubscriptionQuery query={query} setQuery={setQuery} data={data} />
                <FormSpacer />
