...
import PageTypeDetailsPage, { PageTypeDetailsPageProps } from './PageTypeDetailsPage';
...
storiesOf('Page types / Page type details', module)
  ...
  .add('loading', () => <PageTypeDetailsPage {...props} disabled={true} pageTitle={undefined} pageType={undefined} />)
  .add('no attributes', () => (
    <PageTypeDetailsPage
      {...props}
      pageType={{
