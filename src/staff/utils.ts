 ...
 */
export const groupsDiff = (user: StaffMemberDetailsFragment | undefined, formData: StaffDetailsFormData) => {
  if (!user) {
    return {};
  }
...
export const getMemberPermissionGroups = (staffMember: StaffMemberDetailsFragment | UserFragment) => {
