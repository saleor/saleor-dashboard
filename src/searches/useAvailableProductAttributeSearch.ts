...
export default makeSearch<SearchAvailableProductAttributesQuery, SearchAvailableProductAttributesQueryVariables>(
  SearchAvailableProductAttributesDocument,
  result =>
    result.loadMore(
      (prev, next) => {
        ...
        return {
          ...
          productType: {
            ...
            availableAttributes: {
              ...
              edges: [...prev.productType.availableAttributes.edges, ...next.productType.availableAttributes.edges],
