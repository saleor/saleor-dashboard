...
export type ShippingRateUrlDialog = ZipCodeRangeActions | 'remove' | ShippingMethodActions | ChannelsAction;
...
export const shippingRateEditPath = (id: string, rateId: string) => urlJoin(shippingZonePath(id), rateId);
export const shippingRateEditUrl = (id: string, rateId: string, params?: ShippingRateUrlQueryParams) =>
  shippingRateEditPath(encodeURIComponent(id), encodeURIComponent(rateId)) + '?' + stringifyQs(params);
