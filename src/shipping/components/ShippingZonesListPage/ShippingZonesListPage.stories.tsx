...
storiesOf('Shipping / Shipping zones list', module)
  ...
  .add('loading', () => <ShippingZonesListPage {...props} disabled={true} shippingZones={undefined} />)
  .add('no data', () => <ShippingZonesListPage {...props} shippingZones={[]} />)
  .add('no site settings permissions', () => <ShippingZonesListPage {...props} userPermissions={[]} />);
