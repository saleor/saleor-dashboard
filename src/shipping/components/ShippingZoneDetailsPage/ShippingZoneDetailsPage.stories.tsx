...
import ShippingZoneDetailsPage, { ShippingZoneDetailsPageProps } from './ShippingZoneDetailsPage';
...
storiesOf('Shipping / Shipping zone details', module)
  ...
  .add('loading', () => <ShippingZoneDetailsPage {...props} disabled={true} shippingZone={undefined} />)
  .add('form errors', () => (
