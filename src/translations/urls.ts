...
export const languageEntityPath = (code: string, entity: TranslatableEntities, id: string, ...args: string[]) =>
  urlJoin(languageEntitiesPath(code), entity.toString(), id, ...args);
export const languageEntityUrl = (code: string, entity: TranslatableEntities, id: string, ...args: string[]) =>
...
export const productVariantUrl = (code: string, productId: string, variantId: string) =>
  languageEntityUrl(code, TranslatableEntities.products, productId, TranslatableEntities.productVariants, variantId);
