...
import {
  ...
  type LeftOperatorBlurData,
  type LeftOperatorChangeData,
  type LeftOperatorFocusData,
  type LeftOperatorInputValueChangeData,
  type LeftOperatorOption,
  type RightOperatorBlurData,
  type RightOperatorChangeData,
