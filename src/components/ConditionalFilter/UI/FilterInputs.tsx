import { Button, DynamicCombobox, RemoveIcon, Select } from "@saleor/macaw-ui-next";
...
export const FilterInputs = ({ item, index, leftOptions, emitter, error }: FilterInputsProps) => {
