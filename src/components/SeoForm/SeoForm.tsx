...
import { CollectionErrorFragment, PageErrorFragment, ProductErrorFragment } from '@dashboard/graphql';
      ...
      <CardTitle
        ...
        toolbar={
          <Button variant="tertiary" onClick={toggleExpansion} data-test-id="edit-seo">
            <FormattedMessage id="s5Imt5" defaultMessage="Edit website SEO" description="button" />
          </Button>
        }
      />
      <CardContent>
        {shouldDisplayHelperText && (
          <Typography className={clsx({ [classes.helperText]: expanded })}>{helperText}</Typography>
        )}
        {expanded && (
          <div className={classes.container}>
            ...
            <TextField
              ...
              label={
                <div className={classes.labelContainer}>
                  <div className={classes.label}>
                    <FormattedMessage id="w2Cewo" defaultMessage="Search engine title" />
                  </div>
                  {title?.length > 0 && (
                    <span>
                      <FormattedMessage
