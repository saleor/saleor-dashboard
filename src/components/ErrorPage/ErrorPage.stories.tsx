import { AppStateContext, AppStateContextType } from '@dashboard/containers/AppState';
...
const initialAppStateFixture: AppStateContextType = [initialAppState, () => undefined];
