...
export type SaleListUrlQueryParams = ActiveTab &
  ...
  SaleListUrlFilters &
  SaleListUrlSort;
export const saleListUrl = (params?: SaleListUrlQueryParams) => saleListPath + '?' + stringifyQs(params);
...
export const saleAddUrl = (params?: SaleCreateUrlQueryParams) => saleAddPath + '?' + stringifyQs(params);
...
export type VoucherListUrlQueryParams = ActiveTab &
  ...
  VoucherListUrlSort;
export const voucherListUrl = (params?: VoucherListUrlQueryParams) => voucherListPath + '?' + stringifyQs(params);
...
export const voucherAddUrl = (params?: VoucherCreateUrlQueryParams) => voucherAddPath + '?' + stringifyQs(params);
