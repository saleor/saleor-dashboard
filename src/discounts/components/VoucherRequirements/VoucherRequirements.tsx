...
const VoucherRequirements = ({ data, disabled, errors, onChange, onChannelChange }: VoucherRequirementsProps) => {
    ...
    <Card>
      ...
      <CardContent>
        <RadioGroupField
          ...
          onChange={onChange}
        />
        {[RequirementsPicker.ORDER, RequirementsPicker.ITEM].includes(data.requirementsPicker) && <FormSpacer />}
              ...
              <ResponsiveTable className={classes.table}>
                <TableHead colSpan={numberOfColumns} disabled={disabled} items={[]}>
                  ...
                  <TableCell className={classes.colType}>
                    <span>
                      <FormattedMessage id="GVinbz" defaultMessage="Value" description="column title" />
                    </span>
                  </TableCell>
                </TableHead>
                <TableBody>
