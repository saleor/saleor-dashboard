  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <Typography className={classes.ellipsis}>{maybe<React.ReactNode>(() => voucher.code, <Skeleton />)}</Typography>
        <FormSpacer />

        <Typography variant="caption">
          <FormattedMessage id="bcf60I" defaultMessage="Applies to" description="voucher" />
        </Typography>
        <Typography>{maybe<React.ReactNode>(() => translatedVoucherTypes[voucher.type], <Skeleton />)}</Typography>
        <FormSpacer />
        ...
        <Typography variant="caption">
          <FormattedMessage id="FOa+Xd" defaultMessage="Min. Order Value" description="voucher value requirement" />
        </Typography>
        <Typography>{voucher ? channel?.minSpent ? <Money money={channel.minSpent} /> : '-' : <Skeleton />}</Typography>
        <FormSpacer />

        <Typography variant="caption">
          <FormattedMessage id="HLqWXA" defaultMessage="Usage Limit" description="voucher value requirement" />
        </Typography>
        <Typography>
