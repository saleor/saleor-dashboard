...
import SaleDetailsPage, { SaleDetailsPageProps, SaleDetailsPageTab } from './SaleDetailsPage';
...
storiesOf(' Discounts / Sale details', module)
  ...
  .add('loading', () => <SaleDetailsPage {...props} sale={undefined} disabled={true} />)
  .add('form errors', () => (
    <SaleDetailsPage
      {...props}
  ...
  .add('collections', () => <SaleDetailsPage {...props} activeTab={SaleDetailsPageTab.collections} />)
  .add('products', () => <SaleDetailsPage {...props} activeTab={SaleDetailsPageTab.products} />);
