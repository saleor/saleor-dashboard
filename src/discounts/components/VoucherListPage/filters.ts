...
import { createDateField, createNumberField, createOptionsField } from '@dashboard/utils/filters/fields';
...
export function createFilterStructure(intl: IntlShape, opts: VoucherListFilterOpts): IFilter<VoucherFilterKeys> {
  return [
    {
      ...createOptionsField(
    ...
    {
      ...createDateField(VoucherFilterKeys.started, intl.formatMessage(messages.started), opts.started.value),
      active: opts.started.active,
    },
    {
      ...createNumberField(VoucherFilterKeys.timesUsed, intl.formatMessage(messages.timesUsed), opts.timesUsed.value),
      active: opts.timesUsed.active,
    },
    {
      ...createOptionsField(VoucherFilterKeys.status, intl.formatMessage(messages.status), opts.status.value, true, [
        {
    ...
    {
      ...createOptionsField(VoucherFilterKeys.saleType, intl.formatMessage(messages.type), opts.saleType.value, false, [
        {
