...
export interface UserContext {
  ...
  loginByExternalPlugin: (pluginId: string, input: ExternalLoginInput) => Promise<GetExternalAccessTokenData>;
  logout: () => Promise<void>;
  requestLoginByExternalPlugin: (pluginId: string, input: RequestExternalLoginInput) => Promise<GetExternalAuthUrlData>;
  user?: UserFragment;
