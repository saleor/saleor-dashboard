...
const ProductSection = loadable(() => import("./products"));
const CategorySection = loadable(() => import("./categories"));
...
const DiscountSection = loadable(() => import("./discounts"));
const GiftCardSection = loadable(() => import("./giftCards"));
const OrdersSection = loadable(() => import("./orders"));
const PageSection = loadable(() => import("./pages"));
const PageTypesSection = loadable(() => import("./pageTypes"));
const PermissionGroupSection = loadable(() => import("./permissionGroups"));
const PluginsSection = loadable(() => import("./plugins"));
const ProductTypesSection = loadable(() => import("./productTypes"));
const ShippingSection = loadable(() => import("./shipping"));
const SiteSettingsSection = loadable(() => import("./siteSettings"));
const StaffSection = loadable(() => import("./staff"));
const TaxesSection = loadable(() => import("./taxes"));
const TranslationsSection = loadable(() => import("./translations"));
const WarehouseSection = loadable(() => import("./warehouses"));
