...
import B17137 from "./images/app-alerts.png"
import W19387 from "./images/discounts-list.png"
import G11170 from "./images/extensions.jpeg"
import B05903 from "./images/improved_refunds.png"

const app_alerts = () => (<><p><img src={B17137} alt="new filters"/>
...
const discounts_rules = () => (<><p><img src={W19387} alt="Discount rules"/></p>
<p>Apply the new discounts rules to narrow your promotions audience.
Set up conditions and channels that must be fulfilled to apply defined reward.</p>
</>)
const extensions_dev = () => (<></>)
const extensions = () => (<><p><img src={G11170} alt="Extensions"/></p>
<p>New, reshaped experience for browsing, installing, and managing Saleor extensions.</p>
</>)
const improved_refunds = () => (<><p><img src={B05903} alt="Improved refunds"/></p>
