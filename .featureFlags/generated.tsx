...
import H89705 from "./images/app-alerts.jpg"
import K60012 from "./images/collection-filters.jpg"
import D69249 from "./images/customers-filters.png"
import I13696 from "./images/discounts-list.png"
import C34225 from "./images/draft-orders-filters.png"
import S44946 from "./images/gift-cards-filters.png"
import O70190 from "./images/improved_refunds.png"
import K80911 from "./images/page-filters.png"
import U96813 from "./images/vouchers-filters.png"

const app_alerts = () => (<><p><img src={H89705} alt="new filters"/>
...
const collection_filters = () => (<><p><img src={K60012} alt="new filters"/>
Experience the new look and enhanced abilities of new filtering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
const customers_filters = () => (<><p><img src={D69249} alt="new filters"/>
Experience the new look and enhanced abilities of new fitering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
const discounts_rules = () => (<><p><img src={I13696} alt="Discount rules"/></p>
<p>Apply the new discounts rules to narrow your promotions audience.
Set up conditions and channels that must be fulfilled to apply defined reward.</p>
</>)
const draft_orders_filters = () => (<><p><img src={C34225} alt="new filters"/>
Experience the new look and enhanced abilities of new fitering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
const gift_cards_filters = () => (<><p><img src={S44946} alt="new filters"/>
Experience the new look and enhanced abilities of new fitering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
const improved_refunds = () => (<><p><img src={O70190} alt="Improved refunds"/></p>
...
const pages_filters = () => (<><p><img src={K80911} alt="new filters"/>
Experience the new look and enhanced abilities of new fitering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
const vouchers_filters = () => (<><p><img src={U96813} alt="new filters"/>
Experience the new look and enhanced abilities of new fitering mechanism.
Easily combine any criteria you want, and quickly browse their values.</p>
</>)
