...
import D44801 from "./images/app-alerts.png"
import H39353 from "./images/discounts-list.png"
import A78613 from "./images/extensions.png"
import W43123 from "./images/improved_refunds.png"

const app_alerts = () => (<><p><img src={D44801} alt="new filters"/>
...
const discounts_rules = () => (<><p><img src={H39353} alt="Discount rules"/></p>
<p>Apply the new discounts rules to narrow your promotions audience.
Set up conditions and channels that must be fulfilled to apply defined reward.</p>
</>)
const extensions_dev = () => (<></>)
const extensions = () => (<><p><img src={A78613} alt="Extensions"/></p>
<p>New, reshaped experience for browsing, installing, and managing Saleor extensions.</p>
</>)
const improved_refunds = () => (<><p><img src={W43123} alt="Improved refunds"/></p>
